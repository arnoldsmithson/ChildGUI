...
public class GenButton extends JButton implements MouseListener {
    ...
    private boolean correct, clicked, ready = false, visited = false,secVis=false, done = false;//whether this button with image is correct or not
    ...
    public void mouseReleased(MouseEvent e) {click(); }
