...
public class ProgramManager extends JFrame implements WindowListener, WindowStateListener {
    ...
    private void makeFile() {//creates both txt file and either creates or adds onto the csv file
        ...
        if (!fileName.exists()) { //new test subject if this is true
            ...
            while (!valid) {
                ...
                if(bday != null && bday.split("/").length > 2){
        ...
        try {
            ...
            bWriter.write("\nDate and Time: " + year + "/" + month + "/" + myCal.get(Calendar.DAY_OF_MONTH) + " at " + (hour > 12 ? hour -12 : hour) + ":" + myCal.get(Calendar.MINUTE) + ":" + myCal.get(Calendar.SECOND));
...
//Reveal Next
        ...
        try {
            ...
            while (line != null) {
                ...
                if (items[0].equals("1-6")) {//if 1-6 order
                    ...
                    numSlides16++;
                    slides16++;
                    if (i == 15 && slides16 <= 70) {//if 15 slides have passed and we're not at the end
                    ...
                    numSlides13++;
                    slides13++;
                    if (j == 15 && slides13 <= 102) {//same comments as 1-6
    ...
    private void finishTest() {//records when participant finished test
        try {
            finish = true;
            myCal = new GregorianCalendar(); //create calendar for use everywhere
            ...
            bWriter.write("\n\n\nFinished test on: "+ year + "/" + month + "/" + myCal.get(Calendar.DAY_OF_MONTH) + " at " + (hour > 12 ? hour - 12 : hour)+ ":" + myCal.get(Calendar.MINUTE) + ":" + myCal.get(Calendar.SECOND));
            ...
            System.err.println("Can't finish :(");
        }
    }

    private void exitTest() {//records when participant finished test
        try {
            myCal = new GregorianCalendar(); //create calendar for use everywhere
            ...
            bWriter.write("\nExited test on: "+ year + "/" + month + "/" + myCal.get(Calendar.DAY_OF_MONTH) + " at " + (hour > 12 ? hour - 12 : hour) + ":" + myCal.get(Calendar.MINUTE) + ":" + myCal.get(Calendar.SECOND));
